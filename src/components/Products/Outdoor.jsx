                        ...
                        <div className="sm:h-[387px] w-full md:w-[58%] lg:w-[63%]   sm:pl-0 ">
                            ...
                            <div className="md:text-xs  lg:text-[13px]  md:leading-6 space-y-0.5 text-[#666666] lg:pl-[22%] md:pl-10 ">
                                <ul className="list-disc px-5">
                                    ...
                                    <li className="">
                                        Standard input voltage is 24Vdc or 220-240Vac (110-120Vac is
                                        available).
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Light distributions: narrow spot, spot, flood, or wall-wash.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Applicable environment temperature: -20℃&lt;fixture&lt;+45℃.
                                    </li>
                                </ul>
                            </div>
                            <a
